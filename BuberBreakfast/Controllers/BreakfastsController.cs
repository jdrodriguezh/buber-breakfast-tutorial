...
public class BreakfastsController : ApiController
{
  ...
  {
    ErrorOr<Breakfast> getBreakfastResult = _breakfastService.GetBreakfastById(id);
  ...
  public IActionResult UpsertBreakfast(Guid id, UpsertBreakfastRequest request)
  {
    ...
    return upsertBreakfastResult.Match(upserted => upserted.IsNewlyCreated ? CreatedAtGetBreakfast(breakfast) : NoContent(), errors => Problem(errors));
  }
